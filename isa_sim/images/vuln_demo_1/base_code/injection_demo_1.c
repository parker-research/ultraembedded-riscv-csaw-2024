...
void demo_vulnerability_by_copying_trigger_and_payload_to_stack(void) {
    ...
    memcpy_one_by_one_u8(
        ...
        (uint8_t[]) {
            ...
            0xb7, 0x02, 0x00, 0x01, // lui    t0,0x1000
            0x13, 0x03, 0x80, 0x05, // li     t1,88
            0x13, 0x73, 0xf3, 0x0f, // zext.b t1,t1
            0xb3, 0xe2, 0x62, 0x00, // or     t0,t0,t1
            0x73, 0x90, 0x22, 0x7b, // csrw   dscratch0,t0  # (Print t0 in sim.)
            0x6f, 0xf0, 0xdf, 0xff, // j      10 <back to lui>
            // End of payload
            ']',
            'a',
            'b',
